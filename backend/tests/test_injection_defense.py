...
def test_apply_lead_capture_ignores_a_schema_key_that_matches_nothing_configured(db_session):
    ...
    _apply_lead_capture(db_session, parsed, message="hi", schemas=[schema])
    db_session.flush()
...
def test_apply_lead_capture_filters_field_keys_not_defined_on_the_matched_schema(db_session):
...
def test_apply_lead_capture_falls_back_to_inquiry_for_an_invented_category(db_session):
    ...
    _apply_lead_capture(db_session, parsed, message="hi", schemas=[])
    db_session.flush()
...
def test_apply_lead_capture_requires_a_real_looking_email_not_an_injected_string(db_session):
